...
docker tag ts_ted_search:latest 644435390668.dkr.ecr.us-east-1.amazonaws.com/nobel_tedsearch:latest
docker tag ts_ted_nginx:latest 644435390668.dkr.ecr.us-east-1.amazonaws.com/nobel_ted_nginx:latest
